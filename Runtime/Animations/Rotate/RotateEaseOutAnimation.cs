...
{
    /// <summary>
    /// The data representation of the "EaseOut" logic curve.
    ...
    /// </summary>
    [Serializable]
    public class RotateEaseOutConfig : ITweenLogic
    {
        // The display name shown in the "Logic Curve" dropdown in the Inspector.
        public string LogicName => "EaseOut";
        ...
        /// </summary>
        public int GetLogicID() => RotateEaseOutAnimation.LogicID;
    }

    /// <summary>
    /// Executes a EaseOut Rotate transformation loop.
    /// </summary>
    public static class RotateEaseOutAnimation
    {
