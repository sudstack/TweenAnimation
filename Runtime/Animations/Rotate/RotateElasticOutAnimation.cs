...
{
    /// <summary>
    /// The data representation of the "ElasticOut" logic curve.
    ...
    public class RotateElasticOutConfig : ITweenLogic
    {
        ...
        /// </summary>
        public int GetLogicID() => RotateElasticOutAnimation.LogicID;
    }

    /// <summary>
    /// Executes a ElasticOut Rotate transformation loop.
    /// </summary>
    public static class RotateElasticOutAnimation
    {
