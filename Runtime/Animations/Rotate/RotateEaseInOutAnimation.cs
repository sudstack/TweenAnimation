...
{
    /// <summary>
    /// The data representation of the "EaseInOut" logic curve.
    ...
    public class RotateEaseInOutConfig : ITweenLogic
    {
        ...
        /// </summary>
        public int GetLogicID() => RotateEaseInOutAnimation.LogicID;
    }

    /// <summary>
    /// Executes a EaseInOut Rotate transformation loop.
    /// </summary>
    public static class RotateEaseInOutAnimation
    {
