...
{
    /// <summary>
    /// The data representation of the "BounceOut" logic curve.
    ...
    public class RotateBounceOutConfig : ITweenLogic
    {
        ...
        /// </summary>
        public int GetLogicID() => RotateBounceOutAnimation.LogicID;
    }

    /// <summary>
    /// Executes a BounceOut Rotate transformation loop.
    /// </summary>
    public static class RotateBounceOutAnimation
    {
