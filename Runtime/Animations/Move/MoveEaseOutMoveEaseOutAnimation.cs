...
namespace SS.TweenAnimations
{
    ...
    /// </summary>
    [Serializable]
    public class MoveEaseOutConfig : ITweenLogic
    {
        ...
        {
            return MoveEaseOutAnimation.LogicID;
        }
    }

    /// <summary>
    /// The highly optimized, stateless execution logic. 
    /// Designed as a static class to eliminate instantiation overhead and virtual method calls 
    /// during the per-frame PlayerLoop updates.
    /// </summary>
    public static class MoveEaseOutAnimation
    {
