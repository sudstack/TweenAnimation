...
namespace SS.TweenAnimations
{
    ...
    /// </summary>
    [Serializable]
    public class MoveElasticOutConfig : ITweenLogic
    {
        ...
        /// </summary>
        public int GetLogicID() => MoveElasticOutAnimation.LogicID;
    }

    /// <summary>
    /// Executes a translation that severely overshoots the target and wobbles back into place.
    /// Highly energetic. Best used for popping UI elements, error shaking, or spring-based mechanics.
    /// </summary>
    public static class MoveElasticOutAnimation
    {
