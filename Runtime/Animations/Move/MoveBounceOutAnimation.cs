...
namespace SS.TweenAnimations
{
    ...
    /// </summary>
    [Serializable]
    public class MoveBounceOutConfig : ITweenLogic
    {
        ...
        /// </summary>
        public int GetLogicID() => MoveBounceOutAnimation.LogicID;
    }

    /// <summary>
    /// Executes a translation that mimics a physical bounce upon reaching the destination.
    /// Excellent for dropping items on the ground, comedic UI reveals, or notification drops.
    /// </summary>
    public static class MoveBounceOutAnimation
    {
