...
namespace SS.TweenAnimations
{
    ...
    /// </summary>
    [Serializable]
    public class MoveLinearConfig : ITweenLogic
    {
        ...
        /// </summary>
        public int GetLogicID() => MoveLinearAnimation.LogicID;
    }

    /// <summary>
    /// Executes a constant-speed translation without any easing or smoothing.
    /// Perfect for robotic movements, conveyor belts, or constant sliding mechanics.
    /// </summary>
    public static class MoveLinearAnimation
    {
