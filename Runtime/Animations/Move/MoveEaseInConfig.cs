...
namespace SS.TweenAnimations
{
    ...
    /// </summary>
    [Serializable]
    public class MoveEaseInConfig : ITweenLogic
    {
        ...
        /// </summary>
        public int GetLogicID() => MoveEaseInAnimation.LogicID;
    }

    /// <summary>
    /// Executes a translation that starts slowly and accelerates over time.
    /// Ideal for objects dropping, accelerating vehicles, or heavy UI elements leaving the screen.
    /// </summary>
    public static class MoveEaseInAnimation
    {
